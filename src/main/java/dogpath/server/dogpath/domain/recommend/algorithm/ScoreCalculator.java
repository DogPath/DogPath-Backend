package dogpath.server.dogpath.domain.recommend.algorithm;
...
import dogpath.server.dogpath.domain.recommend.repository.CctvRepository;
import dogpath.server.dogpath.domain.recommend.repository.ConstructionRepository;
import dogpath.server.dogpath.domain.recommend.repository.EmergencyBellRepository;
import dogpath.server.dogpath.domain.recommend.repository.FacilityRepository;
import dogpath.server.dogpath.domain.recommend.repository.GasStationRepository;
import dogpath.server.dogpath.domain.recommend.repository.ParkRepository;
import dogpath.server.dogpath.domain.recommend.repository.ParkingLotRepository;
import dogpath.server.dogpath.domain.recommend.repository.SecurityRepository;
import dogpath.server.dogpath.recommend.domain.*;
import dogpath.server.dogpath.recommend.repository.*;
